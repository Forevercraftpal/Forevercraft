...
export const spiritWeapons: SpiritWeapon[] = [
  ...
  {
    id: 5, name: 'Nite', className: 'Dual Swordsman', weaponType: 'Sword',
    bossName: 'The Gatekeeper', structure: 'Stronghold',
    hasTwin: true, twinName: 'Deih',
    lore: 'A blade of glossy black and dark blue. Its twin, Deih, burns with dark orange dawn.',
    color: '#1E3A5F',
    abilities: [
      { name: 'Whirlwind', description: '360° auto-hit all mobs within 4 blocks (6s CD)', unlockTier: 'Rare' },
      { name: 'Twin Resonance', description: 'Both twins held: remove armor penalty + attack speed scaling', unlockTier: 'Spirit' },
      { name: 'Shadow Dance', description: '1/8 chance every 4s: auto-hit all mobs within 3 blocks', unlockTier: 'Uncommon' },
      { name: 'Infinity Edge', description: 'At Spirit tier with both twins: instant attack speed, no cooldown on max swing', unlockTier: 'Spirit' },
    ],
    metamorphosisRequirements: ['All glyph slots filled (Exquisite)', 'Mastery maxed (100,000 XP)', 'All 14 bosses slain', '50,000 kills', 'Kill 10,000 mobs with Whirlwind', 'Obtain Deih via Dream Storm Crystal', 'Defeat The Gatekeeper with both twins equipped'],
  },
  {
