...
export const artifacts: Artifact[] = [
  ...
  // ── Rings ──
  { id: 374, name: 'Amethyst Ring', tier: 'Rare', type: 'Ring', description: 'Grants night vision while worn.', abilities: ['Night Vision'] },
  { id: 375, name: 'Bone Ring', tier: 'Rare', type: 'Ring', description: 'Absorbs damage from undead attacks.', abilities: ['Undead Resistance'] },
  { id: 376, name: 'Aquamarine Ring', tier: 'Rare', type: 'Ring', description: '+1 Dream Rate while in inventory.', abilities: ['Dream Rate +1'] },
  { id: 377, name: 'Emerald Ring', tier: 'Rare', type: 'Ring', description: 'Better trade prices from villagers.', abilities: ['Trade Discount'] },
  { id: 378, name: 'Honey Ring', tier: 'Rare', type: 'Ring', description: 'Slow falling and poison immunity.', abilities: ['Slow Falling', 'Poison Immunity'] },
  { id: 379, name: 'Lapis Ring', tier: 'Rare', type: 'Ring', description: 'Bonus XP from all sources.', abilities: ['XP Boost'] },
  { id: 380, name: 'Nether Ring', tier: 'Rare', type: 'Ring', description: 'Fire resistance while worn.', abilities: ['Fire Resistance'] },
  { id: 381, name: 'Ominous Ring', tier: 'Rare', type: 'Ring', description: 'Bad Omen aura — triggers raids near villages.', abilities: ['Bad Omen'] },
  { id: 382, name: 'Redstone Ring', tier: 'Rare', type: 'Ring', description: 'Speed boost while worn.', abilities: ['Speed I'] },
  { id: 383, name: 'Ring of Undying', tier: 'Exquisite', type: 'Ring', description: 'Totem of undying effect once per hour.', abilities: ['Auto-Revive'] },
  { id: 384, name: 'Slime Ring', tier: 'Rare', type: 'Ring', description: 'Jump boost and no fall damage.', abilities: ['Jump Boost', 'No Fall Damage'] },
  { id: 385, name: 'Trial Ring', tier: 'Rare', type: 'Ring', description: 'Luck boost in trial chambers.', abilities: ['Trial Luck'] },
  { id: 386, name: 'Void Ring', tier: 'Exquisite', type: 'Ring', description: 'Resistance, fire immunity, and slow falling.', abilities: ['Resistance', 'Fire Immunity', 'Slow Falling'] },
  { id: 387, name: 'Warden Ring', tier: 'Exquisite', type: 'Ring', description: 'Darkness immunity and vibration detection.', abilities: ['Darkness Immunity'] },
  // ── Spirit Weapons ──
  { id: 388, name: 'Hollow Fangs', tier: 'Mythical', type: 'Weapon', subtype: 'Dagger', description: 'Spirit Rogue daggers. Shadow Step and Thousand Cuts.', abilities: ['Shadow Step', 'Thousand Cuts'] },
  { id: 389, name: 'Sabrewing', tier: 'Mythical', type: 'Weapon', subtype: 'Bow', description: 'Spirit Archer bow. Soulstring Overcharge and Phantom Arrow.', abilities: ['Soulstring Overcharge', 'Phantom Arrow'] },
  { id: 390, name: 'Firebrand', tier: 'Mythical', type: 'Weapon', subtype: 'Axe', description: 'Spirit Berserker axe. Earthshatter and Inferno Cleave.', abilities: ['Earthshatter', 'Inferno Cleave'] },
  { id: 391, name: 'Zephyr Edge', tier: 'Mythical', type: 'Weapon', subtype: 'Fan', description: 'Spirit Dancer fans. Cyclone and Wind Dance.', abilities: ['Cyclone', 'Wind Dance'] },
  { id: 392, name: 'Nite', tier: 'Mythical', type: 'Weapon', subtype: 'Sword', description: 'Spirit ??? class sword. Glossy black with dark blue accents.', abilities: ['???', '???'] },
  { id: 393, name: 'Whispering Spear', tier: 'Mythical', type: 'Weapon', subtype: 'Spear', description: 'Spirit Beastlord spear. Wild Summon and Pack Command.', abilities: ['Wild Summon', 'Pack Command'] },
  { id: 394, name: 'Ashcrown Mace', tier: 'Mythical', type: 'Weapon', subtype: 'Mace', description: 'Spirit Sentinel mace. Ashen Slam and Fortify.', abilities: ['Ashen Slam', 'Fortify'] },
  { id: 395, name: 'Ellegaard\'s Trident', tier: 'Mythical', type: 'Weapon', subtype: 'Trident', description: 'Spirit Javelin trident. Tidal Surge and Riptide Lance.', abilities: ['Tidal Surge', 'Riptide Lance'] },
  { id: 396, name: 'Order of the Stone Gauntlet', tier: 'Mythical', type: 'Weapon', subtype: 'Gauntlet', description: 'Spirit Striker gauntlet. Seismic Punch and Meteor Strike.', abilities: ['Seismic Punch', 'Meteor Strike'] },
  { id: 397, name: 'Lifewoven Branch', tier: 'Mythical', type: 'Weapon', subtype: 'Staff', description: 'Spirit Healer staff. Bloom of Life and Verdant Shield.', abilities: ['Bloom of Life', 'Verdant Shield'] },
  { id: 398, name: 'Dragonheart Sword', tier: 'Mythical', type: 'Weapon', subtype: 'Sword', description: 'Spirit Knight sword. Dragon Slash and Valor Guard.', abilities: ['Dragon Slash', 'Valor Guard'] },
  { id: 399, name: 'Royal Trident', tier: 'Mythical', type: 'Weapon', subtype: 'Trident', description: 'Spirit Hoplite trident. Phalanx Thrust and Shield Wall.', abilities: ['Phalanx Thrust', 'Shield Wall'] },
  { id: 400, name: 'Guardian Bow', tier: 'Mythical', type: 'Weapon', subtype: 'Crossbow', description: 'Spirit Hunter crossbow. Steady Aim and Precision Shot.', abilities: ['Steady Aim', 'Precision Shot'] },
  { id: 401, name: 'Bulwark Shield', tier: 'Mythical', type: 'Shield', description: 'Spirit Tank shield. Aegis Wall and Taunt.', abilities: ['Aegis Wall', 'Taunt'] },
  // ── Twin Weapons (Dream Storm Crystal) ──
  { id: 402, name: 'Deih', tier: 'Mythical', type: 'Weapon', subtype: 'Sword', description: 'Twin of Nite. Dark orange dawn blade.', abilities: ['Twin Resonance'] },
  { id: 403, name: 'Aqualoch', tier: 'Mythical', type: 'Weapon', subtype: 'Axe', description: 'Twin of Firebrand. Aqua blue berserker axe.', abilities: ['Twin Resonance'] },
  { id: 404, name: 'Ghost Fang', tier: 'Mythical', type: 'Weapon', subtype: 'Dagger', description: 'Twin of Hollow Fangs. Snow-touched rogue dagger.', abilities: ['Twin Resonance'] },
  { id: 405, name: 'Johan Shield', tier: 'Mythical', type: 'Shield', description: 'Twin of Dragonheart Sword. Knight class shield.', abilities: ['Twin Resonance'] },
  { id: 406, name: 'Vanguard Shield', tier: 'Mythical', type: 'Shield', description: 'Twin of Royal Trident. Hoplite class shield.', abilities: ['Twin Resonance'] },
  { id: 407, name: 'Ashcrown Shield', tier: 'Mythical', type: 'Shield', description: 'Twin of Ashcrown Mace. Sentinel class shield.', abilities: ['Twin Resonance'] },
  { id: 408, name: 'Storm Edge', tier: 'Mythical', type: 'Weapon', subtype: 'Fan', description: 'Twin of Zephyr Edge. Dancer class twin fan.', abilities: ['Twin Resonance'] },
]
