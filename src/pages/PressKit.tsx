...
const QUICK_FACTS = [
  ...
  { label: 'Artifacts', value: '600+' },
  { label: 'Companions', value: '104' },
  { label: 'Spirit Weapons', value: '14' },
  { label: 'Raid Bosses', value: '13' },
  { label: 'Skill Trees', value: '15' },
  { label: 'Quests', value: '450+' },
  { label: 'Lore Fragments', value: '896' },
  { label: 'Functions', value: '22,472' },
  { label: 'Total Files', value: '34,159' },
  { label: 'Minecraft Version', value: '26.2' },
  { label: 'Pack Format', value: '107.1' },
]
  ...
  return (
    <div className="bg-stone-950 text-stone-200 min-h-screen">
      ...
      <div className="max-w-[1200px] mx-auto px-8 py-16">
        ...
        <ScrollReveal>
          <div className="mb-16">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-6">SHORT DESCRIPTION</h2>
            <div className="rounded-3xl border border-stone-800/60 bg-stone-900/30 p-6">
              <p className="font-['Crimson_Pro'] text-lg text-stone-300 leading-relaxed">
                Forevercraft is a loot-driven fantasy overhaul for vanilla Minecraft with 600+ artifacts,
                104 companions, 14 spirit weapons, 13 raid bosses, an infinite castle, 15 skill trees,
                450+ quests, and 150+ interconnected systems. No mods required.
                Every world has treasure. This one has dreams.
              </p>
              <button
                onClick={() => navigator.clipboard.writeText('Forevercraft is a loot-driven fantasy overhaul for vanilla Minecraft with 600+ artifacts, 104 companions, 14 spirit weapons, 13 raid bosses, an infinite castle, 15 skill trees, 450+ quests, and 150+ interconnected systems. No mods required. Every world has treasure. This one has dreams.')}
                className="mt-4 px-4 py-2 rounded border border-yellow-800/40 hover:border-yellow-600/60 font-['Pixelify_Sans'] text-[0.55rem] text-stone-500 hover:text-yellow-500 tracking-widest transition-colors"
              >
                COPY TO CLIPBOARD
              </button>
            </div>
        ...
        <ScrollReveal delay={50}>
          <div className="mb-16">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-6">TAGLINE</h2>
            <div className="rounded-3xl border border-stone-800/60 bg-stone-900/30 p-6">
        ...
        <ScrollReveal delay={100}>
          <div className="mb-16">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-6">QUICK FACTS</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {QUICK_FACTS.map(fact => (
                <div key={fact.label} className="rounded-3xl border border-stone-800/60 bg-stone-900/30 p-4 text-center">
                  <div className="font-['Pixelify_Sans'] text-[1rem] text-yellow-400 mb-1">{fact.value}</div>
                  <div className="font-['Pixelify_Sans'] text-[0.55rem] text-stone-500 tracking-widest">{fact.label.toUpperCase()}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <ScrollReveal delay={150}>
          <div className="mb-16">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-6">DOWNLOADABLE ASSETS</h2>
              ...
              {ASSETS.map(asset => (
                <div key={asset.name} className="rounded-3xl border border-stone-800/60 bg-stone-900/30 p-5 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-['Pixelify_Sans'] text-[0.6rem] text-stone-200 mb-1">{asset.name}</h3>
                    <p className="font-['Crimson_Pro'] text-sm text-stone-500">{asset.desc}</p>
                  </div>
                  <a
                    href={asset.file}
                    download
                    className="px-3 py-2 rounded border border-yellow-800/40 hover:border-yellow-600/60 font-['Pixelify_Sans'] text-[0.55rem] text-stone-500 hover:text-yellow-500 tracking-widest transition-colors no-underline"
                  >
                    DOWNLOAD
                  </a>
                </div>
        ...
        <ScrollReveal delay={200}>
          <div className="mb-16">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-6">OFFICIAL LINKS</h2>
            <div className="rounded-3xl border border-stone-800/60 bg-stone-900/30 p-6 space-y-3">
              {[
                ...
                <div key={link.label} className="flex items-center gap-4">
                  <span className="font-['Pixelify_Sans'] text-[0.55rem] text-stone-400 w-32">{link.label}</span>
        ...
        <ScrollReveal delay={250}>
          <div className="text-center">
            <h2 className="font-['Pixelify_Sans'] text-[0.75rem] text-yellow-500 tracking-widest mb-4">CONTACT</h2>
            <p className="font-['Crimson_Pro'] text-lg text-stone-400">
              For press inquiries, content creator access, or collaboration:
            </p>
            <p className="font-['Pixelify_Sans'] text-[0.7rem] text-yellow-500 mt-2">
