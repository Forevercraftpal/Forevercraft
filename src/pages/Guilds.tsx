    ...
    <div className="bg-stone-950 text-stone-200 min-h-screen">
      ...
      <section className="max-w-[1400px] mx-auto px-8 py-16">
        <ScrollReveal>
          <div className="text-center mb-10">
            <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">GUILDS</h2>
          ...
          {GUILD_FEATURES.map((feat, i) => (
            <ScrollReveal key={feat.name} delay={i * 60}>
              <div className="rounded-3xl border border-blue-900/30 bg-blue-950/15 p-5 h-full">
                <h3 className="font-['Pixelify_Sans'] text-[0.7rem] text-blue-400 mb-2">{feat.name}</h3>
      ...
      <section className="border-t border-yellow-900/20">
        <div className="max-w-[1400px] mx-auto px-8 py-16">
          <ScrollReveal>
            <div className="text-center mb-10">
              <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">PARTY COMBOS</h2>
              <p className="font-['Crimson_Pro'] text-lg text-stone-400 max-w-2xl mx-auto">
              ...
              <ScrollReveal key={combo.name} delay={i * 50}>
                <div className="rounded-3xl border border-stone-800 bg-stone-900/30 p-4 h-full">
                  <div className="flex items-baseline justify-between mb-2">
                    <h3 className={`font-['Pixelify_Sans'] text-[0.65rem] ${combo.color}`}>{combo.name}</h3>
                    <span className="font-['Pixelify_Sans'] text-[0.7rem] text-stone-600">{combo.players}+ players</span>
                  </div>
      ...
      <section className="border-t border-yellow-900/20">
        <div className="max-w-[1400px] mx-auto px-8 py-16">
          <ScrollReveal>
            <div className="text-center mb-10">
              <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">DUELS</h2>
            ...
            {DUEL_FEATURES.map((duel, i) => (
              <ScrollReveal key={duel.type} delay={i * 80}>
                <div className="rounded-3xl border border-red-900/30 bg-red-950/10 p-5 h-full">
                  <h3 className="font-['Pixelify_Sans'] text-[0.7rem] text-red-400 mb-2">{duel.type}</h3>
      ...
      <section className="border-t border-yellow-900/20">
        <div className="max-w-[1400px] mx-auto px-8 py-16">
          <ScrollReveal>
            <div className="text-center mb-10">
              <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">BUDDY SYSTEM</h2>
              <p className="font-['Crimson_Pro'] text-lg text-stone-400 max-w-2xl mx-auto">
            ...
            {BUDDY_TIERS.map((bt, i) => (
              <ScrollReveal key={bt.tier} delay={i * 50}>
                <div className="text-center rounded-3xl border border-stone-800 bg-stone-900/40 px-4 py-3">
                  <p className="font-['Pixelify_Sans'] text-[0.55rem] text-stone-600 mb-1">TIER {bt.tier}</p>
                  <p className={`font-['Pixelify_Sans'] text-[0.65rem] ${bt.color}`}>{bt.name}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="border-t border-yellow-900/20">
        <div className="max-w-[1400px] mx-auto px-8 py-16">
          <ScrollReveal>
            <div className="text-center mb-10">
              <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">FRIENDSHIP</h2>
              <p className="font-['Crimson_Pro'] text-lg text-stone-400 max-w-2xl mx-auto">
              ...
              <ScrollReveal key={fl.level} delay={i * 80}>
                <div className="rounded-3xl border border-stone-800 bg-stone-900/30 p-4">
                  <div className="flex items-baseline justify-between mb-1">
                    <h3 className={`font-['Pixelify_Sans'] text-[0.7rem] ${fl.color}`}>{fl.name}</h3>
      ...
      <section className="border-t border-yellow-900/20">
        <div className="max-w-[1400px] mx-auto px-8 py-16">
          <ScrollReveal>
            <div className="text-center mb-10">
              <h2 className="font-['Pixelify_Sans'] text-base text-yellow-400 mb-3">FAMILY & MARRIAGE</h2>
              <p className="font-['Crimson_Pro'] text-lg text-stone-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <ScrollReveal delay={0}>
              <div className="rounded-3xl border border-pink-900/30 bg-pink-950/10 p-5 text-center h-full">
                <p className="font-['Pixelify_Sans'] text-[0.7rem] text-pink-400 mb-2">PROPOSAL</p>
            ...
            <ScrollReveal delay={80}>
              <div className="rounded-3xl border border-pink-900/30 bg-pink-950/10 p-5 text-center h-full">
                <p className="font-['Pixelify_Sans'] text-[0.7rem] text-pink-400 mb-2">SHARED PERKS</p>
            ...
            <ScrollReveal delay={160}>
              <div className="rounded-3xl border border-pink-900/30 bg-pink-950/10 p-5 text-center h-full">
                <p className="font-['Pixelify_Sans'] text-[0.7rem] text-pink-400 mb-2">ETERNAL VOW</p>
