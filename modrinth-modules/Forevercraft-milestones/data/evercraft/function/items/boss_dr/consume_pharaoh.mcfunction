# Consume Dynasty Ember — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_pharaoh

advancement revoke @s only evercraft:items/boss_dr/consume_pharaoh
...
attribute @s luck modifier add evercraft:boss_dr_9 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"DYNASTY EMBER CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
