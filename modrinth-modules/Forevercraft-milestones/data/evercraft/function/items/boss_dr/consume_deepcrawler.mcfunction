# Consume Crystallized Depths — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_deepcrawler

advancement revoke @s only evercraft:items/boss_dr/consume_deepcrawler
...
attribute @s luck modifier add evercraft:boss_dr_11 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"CRYSTALLIZED DEPTHS CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
