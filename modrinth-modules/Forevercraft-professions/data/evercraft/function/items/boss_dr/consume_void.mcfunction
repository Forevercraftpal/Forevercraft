# Consume Void Fragment — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_void

advancement revoke @s only evercraft:items/boss_dr/consume_void
...
attribute @s luck modifier add evercraft:boss_dr_2 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"VOID FRAGMENT CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
