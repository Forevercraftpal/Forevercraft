# Consume Deep Sea Pearl — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_leviathan

advancement revoke @s only evercraft:items/boss_dr/consume_leviathan
...
attribute @s luck modifier add evercraft:boss_dr_8 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"DEEP SEA PEARL CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
