...
tellraw @p[distance=..20] [{text:"[Forevercraft] ",color:"gold"},{text:"An Uncommon Fishing Crate has appeared!",color:"blue"}]
...
execute unless score @p ec.lure_count matches 1.. if predicate {"condition":"minecraft:random_chance","chance":0.005} run function evercraft:crate_anim/finish/fishing/give_lure
