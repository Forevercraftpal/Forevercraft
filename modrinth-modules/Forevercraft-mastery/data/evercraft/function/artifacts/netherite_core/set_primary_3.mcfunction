...
execute unless items entity @s weapon.mainhand minecraft:stick[custom_data~{ancient_netherite_core:1b}] run return 0
execute unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:2b}] unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:3b}] unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:4b}] run tellraw @s ["",{text:"Requires Level 2 or higher!",color:"red"}]
execute unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:2b}] unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:3b}] unless items entity @s weapon.mainhand minecraft:stick[custom_data~{level:4b}] run return 0
...
data modify entity @e[type=hopper_minecart,tag=ec.temp_cart,limit=1] Items set value []
