...
execute if entity @s[advancements={evercraft:artifacts/collected/celestial_lotus=true}] run scoreboard players add @s adv.temp 1
execute if entity @s[advancements={evercraft:artifacts/collected/ember_fishing_rod=true}] run scoreboard players add @s adv.temp 1
execute if entity @s[advancements={evercraft:artifacts/collected/lifewardens_tome=true}] run scoreboard players add @s adv.temp 1
execute if entity @s[advancements={evercraft:artifacts/collected/order_of_the_stone_gauntlet=true}] run scoreboard players add @s adv.temp 1
