# Consume Living Stone Fragment — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_mossheart

advancement revoke @s only evercraft:items/boss_dr/consume_mossheart
...
attribute @s luck modifier add evercraft:boss_dr_12 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"LIVING STONE FRAGMENT CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
