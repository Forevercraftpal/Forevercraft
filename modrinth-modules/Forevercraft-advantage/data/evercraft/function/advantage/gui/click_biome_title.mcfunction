# Handle biome title click — run as the interaction entity
# Macro arg: id (1-25, maps to biome 0-24)
...
$execute as @a[tag=Adv.InMenu,distance=..10] if score @s adv.gui_session = #gui_click_sess ec.temp run function evercraft:advantage/gui/do_biome_title {id:$(id)}
