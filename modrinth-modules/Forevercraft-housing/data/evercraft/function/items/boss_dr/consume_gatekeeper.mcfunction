# Consume Shattered Gate Fragment — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_gatekeeper

advancement revoke @s only evercraft:items/boss_dr/consume_gatekeeper
...
attribute @s luck modifier add evercraft:boss_dr_5 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"SHATTERED GATE FRAGMENT CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
