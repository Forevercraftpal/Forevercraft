# ============================================================
# Artifact Bounty Board — Turn In Slot 1
# ============================================================
...
scoreboard players set @s ec.abb_claim_1 1

data modify storage eden:database bounty_board.temp.coins set from storage eden:database bounty_board.bounties[1].coins
data modify storage eden:database bounty_board.temp.name set from storage eden:database bounty_board.bounties[1].name
data modify storage eden:database bounty_board.temp.tier set from storage eden:database bounty_board.bounties[1].tier
