...
execute unless score @s ec.quest_id_6 matches 1.. run tellraw @s ["",{text:"[Forevercraft] ",color:"gold"},{text:"You don't have a Heroic quest to cancel.",color:"gray"}]
...
tellraw @s ["",{text:"[Forevercraft] ",color:"gold"},{text:"Heroic quest cancelled. ",color:"yellow"},{text:"-100 reputation.",color:"red"}]
