...
execute unless entity @s[tag=verdant_4pc] run tellraw @s [{text:"[Forevercraft] ",color:"gold"},{text:"You need the full Grove set (4pc) to use Harvest Caller!",color:"red"}]
