# Consume Purified Venom Gland — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_venomweaver

advancement revoke @s only evercraft:items/boss_dr/consume_venomweaver
...
attribute @s luck modifier add evercraft:boss_dr_10 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"PURIFIED VENOM GLAND CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
