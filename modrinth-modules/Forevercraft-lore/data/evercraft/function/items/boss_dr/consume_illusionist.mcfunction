# Consume Bottled Nightmare — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_illusionist

advancement revoke @s only evercraft:items/boss_dr/consume_illusionist
...
attribute @s luck modifier add evercraft:boss_dr_6 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"BOTTLED NIGHTMARE CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
