# Glyphforge — Spawn item_display overlaying the lodestone block
# Macro function: requires temp_skin (Base64 texture) in evercraft:glyphforge storage
