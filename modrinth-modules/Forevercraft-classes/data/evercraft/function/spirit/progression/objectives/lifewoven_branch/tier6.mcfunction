# Lifewoven Branch — Exquisite → Mythical (9 objectives)
# 1. Kill 15,000 mobs
...
# 3. Heal 75,000 HP in combat
execute if score @s ec.sp_combat_heals matches 75000.. run scoreboard players add @s ec.sp_obj_done 1
