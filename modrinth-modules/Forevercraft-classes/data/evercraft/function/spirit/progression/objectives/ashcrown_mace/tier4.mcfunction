# Ashcrown Mace — Rare → Ornate (7 objectives)
# 1. Kill 2,000 mobs
...
# 3. Block 10,000 damage
execute if score @s ec.sp_damage_blocked matches 10000.. run scoreboard players add @s ec.sp_obj_done 1
