# Ashcrown Mace — Exquisite → Mythical (9 objectives)
# 1. Kill 15,000 mobs
...
# 3. Block 75,000 damage
execute if score @s ec.sp_damage_blocked matches 75000.. run scoreboard players add @s ec.sp_obj_done 1
