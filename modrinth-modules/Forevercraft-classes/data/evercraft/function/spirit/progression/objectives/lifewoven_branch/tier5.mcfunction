# Lifewoven Branch — Ornate → Exquisite (8 objectives)
# 1. Kill 5,000 mobs
...
# 3. Heal 25,000 HP in combat
execute if score @s ec.sp_combat_heals matches 25000.. run scoreboard players add @s ec.sp_obj_done 1
...
# 8. Heal allies for 5,000 HP
execute if score @s ec.sp_ally_heals matches 5000.. run scoreboard players add @s ec.sp_obj_done 1
