# Bulwark Shield — Mythical → Spirit (10 objectives)
# 1. Kill 50,000 mobs
execute if score @s ec.sp_kills matches 50000.. run scoreboard players add @s ec.sp_obj_done 1
# 2. Absorb 200,000 damage
execute if score @s ec.sp_total_absorb matches 200000.. run scoreboard players add @s ec.sp_obj_done 1
...
# 7. Taunt 5,000 mobs
execute if score @s ec.sp_taunts matches 5000.. run scoreboard players add @s ec.sp_obj_done 1
# 8. Survive 10 deathless hours
execute if score @s ec.sp_deathless_hours matches 10.. run scoreboard players add @s ec.sp_obj_done 1
