# Ellegaard Trident — Ornate → Exquisite (8 objectives)
# 1. Kill 5,000 mobs
...
# 3. Get 2,000 thrown kills
execute if score @s ec.sp_thrown_kills matches 2000.. run scoreboard players add @s ec.sp_obj_done 1
...
# 8. Explore 10 ocean structures
execute if score @s ec.sp_ocean_explore matches 10.. run scoreboard players add @s ec.sp_obj_done 1
