# Bulwark Shield — Progress Display
tellraw @s [{"text":"═══ ","color":"gray"},{"text":"Bulwark Shield","color":"gray","bold":true},{"text":" — ","color":"dark_gray"},{"text":"","color":"gray"},{"score":{"name":"@s","objective":"ec.sp_eff"}},{"text":"% Effectiveness","color":"gray"},{"text":" ═══","color":"gray"}]
...
execute if score @s ec.sp_tier matches 1 run function evercraft:spirit/progression/display/bulwark_shield_t2
execute if score @s ec.sp_tier matches 2 run function evercraft:spirit/progression/display/bulwark_shield_t3
execute if score @s ec.sp_tier matches 3 run function evercraft:spirit/progression/display/bulwark_shield_t4
execute if score @s ec.sp_tier matches 4 run function evercraft:spirit/progression/display/bulwark_shield_t5
execute if score @s ec.sp_tier matches 5 run function evercraft:spirit/progression/display/bulwark_shield_t6
execute if score @s ec.sp_tier matches 6 run function evercraft:spirit/progression/display/bulwark_shield_t7
