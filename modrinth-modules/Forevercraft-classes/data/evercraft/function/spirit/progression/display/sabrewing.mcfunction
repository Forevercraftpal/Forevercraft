# Sabrewing — Progress Display
tellraw @s [{"text":"═══ ","color":"white"},{"text":"Sabrewing","color":"white","bold":true},{"text":" — ","color":"dark_gray"},{"text":"","color":"gray"},{"score":{"name":"@s","objective":"ec.sp_eff"}},{"text":"% Effectiveness","color":"gray"},{"text":" ═══","color":"white"}]
...
execute if score @s ec.sp_tier matches 1 run function evercraft:spirit/progression/display/sabrewing_t2
execute if score @s ec.sp_tier matches 2 run function evercraft:spirit/progression/display/sabrewing_t3
execute if score @s ec.sp_tier matches 3 run function evercraft:spirit/progression/display/sabrewing_t4
execute if score @s ec.sp_tier matches 4 run function evercraft:spirit/progression/display/sabrewing_t5
execute if score @s ec.sp_tier matches 5 run function evercraft:spirit/progression/display/sabrewing_t6
execute if score @s ec.sp_tier matches 6 run function evercraft:spirit/progression/display/sabrewing_t7
