# Milestones — Open Craftforever Titles
# Run as the player, at the player, facing the anchor (set by enter_craftforever)
...
# Set page 21 (craftforever titles)
scoreboard players set @s adv.gui_page 21
...
# Spawn craftforever claims content
function evercraft:ecodex/sections/craftforever_claims
