# Eat Warrior's Banquet — AoE Strength I + Resistance I (3 min)
# Buffs all players within 16 blocks
advancement revoke @s only evercraft:cooking/eat_feast_warriors
...
execute at @s run effect give @a[distance=..16,tag=!CK.FeastSelf] minecraft:strength 180 0 true
execute at @s run effect give @a[distance=..16,tag=!CK.FeastSelf] minecraft:resistance 180 0 true
execute at @s as @a[distance=..16,tag=!CK.FeastSelf] run tellraw @s [{text:"[Feast Platter] ",color:"#FFD700"},{text:"Warrior's Banquet! ",color:"#FF6B6B"},{text:"Strength I + Resistance I for 3 min",color:"gray"}]
tag @s remove CK.FeastSelf

# Self buff
effect give @s minecraft:strength 180 0 true
effect give @s minecraft:resistance 180 0 true
execute if score @s adv.pa_culi3 matches 1 run effect give @s minecraft:strength 360 0 true
...
# Feedback
tellraw @s [{text:"[Feast Platter] ",color:"#FFD700"},{text:"Warrior's Banquet! ",color:"#FF6B6B"},{text:"Strength I + Resistance I for 3 min",color:"gray"}]
...
scoreboard players set @s ec.meal_ate 50
