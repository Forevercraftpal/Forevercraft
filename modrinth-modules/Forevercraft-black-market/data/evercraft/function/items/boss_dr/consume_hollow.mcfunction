# Consume Echo of the Deep — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_hollow

advancement revoke @s only evercraft:items/boss_dr/consume_hollow
...
attribute @s luck modifier add evercraft:boss_dr_1 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"ECHO OF THE DEEP CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
