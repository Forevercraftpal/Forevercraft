# Consume Molten Gold Core — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_gilded

advancement revoke @s only evercraft:items/boss_dr/consume_gilded
...
attribute @s luck modifier add evercraft:boss_dr_3 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"MOLTEN GOLD CORE CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
