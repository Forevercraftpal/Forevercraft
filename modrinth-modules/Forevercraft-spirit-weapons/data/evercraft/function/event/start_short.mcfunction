# Dream Surge Event — START (3 Minutes)
# Admin command: /function evercraft:event/start_short
# Same as start.mcfunction but lasts 3 minutes (3600 ticks)
...
scoreboard players set #ec_event_timer ec.var 3600
...
tellraw @a [{text:"  "},{text:"For the next 3 minutes:",color:"gray"}]
