# Pharaoh's Fist — Progress Display
tellraw @s [{"text":"═══ ","color":"yellow"},{"text":"Pharaoh's Fist","color":"yellow","bold":true},{"text":" — ","color":"dark_gray"},{"text":"","color":"gray"},{"score":{"name":"@s","objective":"ec.sp_eff"}},{"text":"% Effectiveness","color":"gray"},{"text":" ═══","color":"yellow"}]
...
execute if score @s ec.sp_tier matches 1 run function evercraft:spirit/progression/display/pharaoh_fist_t2
execute if score @s ec.sp_tier matches 2 run function evercraft:spirit/progression/display/pharaoh_fist_t3
execute if score @s ec.sp_tier matches 3 run function evercraft:spirit/progression/display/pharaoh_fist_t4
execute if score @s ec.sp_tier matches 4 run function evercraft:spirit/progression/display/pharaoh_fist_t5
execute if score @s ec.sp_tier matches 5 run function evercraft:spirit/progression/display/pharaoh_fist_t6
execute if score @s ec.sp_tier matches 6 run function evercraft:spirit/progression/display/pharaoh_fist_t7
