# Sabrewing — Exquisite → Mythical (9 objectives)
# 1. Kill 15,000 mobs
...
# 3. Land 5,000 critical shots
execute if score @s ec.sp_crits matches 5000.. run scoreboard players add @s ec.sp_obj_done 1
