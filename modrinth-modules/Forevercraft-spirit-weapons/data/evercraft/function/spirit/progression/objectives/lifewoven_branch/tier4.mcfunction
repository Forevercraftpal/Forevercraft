# Lifewoven Branch — Rare → Ornate (7 objectives)
# 1. Kill 2,000 mobs
...
# 3. Heal 10,000 HP in combat
execute if score @s ec.sp_combat_heals matches 10000.. run scoreboard players add @s ec.sp_obj_done 1
