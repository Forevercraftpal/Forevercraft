# Lifewoven Branch — Common → Uncommon (5 objectives)
# 1. Kill 100 mobs
execute if score @s ec.sp_kills matches 100.. run scoreboard players add @s ec.sp_obj_done 1
# 2. Heal 500 HP in combat
execute if score @s ec.sp_combat_heals matches 500.. run scoreboard players add @s ec.sp_obj_done 1
# 3. Visit 5 biomes
