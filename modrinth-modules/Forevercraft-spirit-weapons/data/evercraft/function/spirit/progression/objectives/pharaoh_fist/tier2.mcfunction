# Pharaoh's Fist — Common → Uncommon (5 objectives)
# 1. Kill 100 mobs
execute if score @s ec.sp_kills matches 100.. run scoreboard players add @s ec.sp_obj_done 1
# 2. Land 50 impact strikes
execute if score @s ec.sp_impact_hits matches 50.. run scoreboard players add @s ec.sp_obj_done 1
# 3. Visit 5 biomes
