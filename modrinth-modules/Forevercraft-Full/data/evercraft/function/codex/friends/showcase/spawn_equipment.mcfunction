# Showcase — Spawn equipment row (self-view)
# Run as the player with corrected facing context
# Layout: [pick] [weapon] [helm] [chest] [legs] [boots] [offhand] [shovel]
# Weapon/pick/shovel detected from hotbar, armor + offhand from equipment slots

# Pickaxe at ^0.49 (from hotbar)
...
function evercraft:codex/friends/showcase/detect_tool
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new

# Weapon at ^0.35 (from hotbar)
...
function evercraft:codex/friends/showcase/detect_weapon
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
...
data modify entity @e[type=item_display,tag=ec.sc_eq_new,limit=1,sort=nearest] item set from entity @s equipment.head
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
...
data modify entity @e[type=item_display,tag=ec.sc_eq_new,limit=1,sort=nearest] item set from entity @s equipment.chest
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
...
data modify entity @e[type=item_display,tag=ec.sc_eq_new,limit=1,sort=nearest] item set from entity @s equipment.legs
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
...
data modify entity @e[type=item_display,tag=ec.sc_eq_new,limit=1,sort=nearest] item set from entity @s equipment.feet
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
...
data modify entity @e[type=item_display,tag=ec.sc_eq_new,limit=1,sort=nearest] item set from entity @s equipment.offhand
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new

# Shovel at ^-0.49 (from hotbar)
...
function evercraft:codex/friends/showcase/detect_shovel
tag @e[tag=ec.sc_eq_new] remove ec.sc_eq_new
