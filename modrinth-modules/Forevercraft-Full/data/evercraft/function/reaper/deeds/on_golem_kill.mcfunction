...
tellraw @s [{text:"  ",color:"dark_gray"},{text:"☠ ",color:"dark_red"},{text:"The iron sentinels mark your transgression... ",color:"red",italic:true},{text:"(+",color:"gray"},{score:{name:"#rp_add",objective:"rp.temp"},color:"gray"},{text:" Infamy)",color:"gray"}]
