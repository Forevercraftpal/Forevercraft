...
tellraw @s [{"text":"  "},{"text":"Quest ","color":"gray"},{"score":{"name":"@s","objective":"ec.sq_part"},"color":"white"},{"text":" of 100","color":"gray"}]
...
title @s title {"text":"Quest Activated","color":"aqua","bold":true}
