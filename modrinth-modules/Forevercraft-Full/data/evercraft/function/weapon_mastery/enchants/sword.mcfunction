...
# Ench 1+: Sharpness
execute if score #wm_ench_level ec.var matches 1.. run function evercraft:mastery/set_enchant_if_higher {enchant:"sharpness",tag:"wm_temp"}

# Ench 2+: Fire Aspect
execute if score #wm_ench_level ec.var matches 2.. run function evercraft:mastery/set_enchant_if_higher {enchant:"fire_aspect",tag:"wm_temp"}

# Ench 3+: Sweeping Edge
execute if score #wm_ench_level ec.var matches 3.. run function evercraft:mastery/set_enchant_if_higher {enchant:"sweeping_edge",tag:"wm_temp"}
