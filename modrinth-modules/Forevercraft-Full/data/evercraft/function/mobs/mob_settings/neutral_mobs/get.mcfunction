...
execute if data storage eden:settings bestiary.misc{irongolemanger:"disabled"} as @s[type=minecraft:iron_golem] run data modify entity @s PlayerCreated set value 1b
...
function evercraft:mobs/mob_settings/neutral_mobs/exec with storage eden:temp bestiary