# Consume Iron Will Crystal — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_crimson

advancement revoke @s only evercraft:items/boss_dr/consume_crimson
...
attribute @s luck modifier add evercraft:boss_dr_13 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"IRON WILL CRYSTAL CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
