# Ellegaard Trident — Exquisite → Mythical (9 objectives)
# 1. Kill 15,000 mobs
...
# 3. Get 5,000 thrown kills
execute if score @s ec.sp_thrown_kills matches 5000.. run scoreboard players add @s ec.sp_obj_done 1
