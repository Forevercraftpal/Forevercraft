# Sabrewing — Rare → Ornate (7 objectives)
# 1. Kill 2,000 mobs
...
# 3. Land 500 critical shots
execute if score @s ec.sp_crits matches 500.. run scoreboard players add @s ec.sp_obj_done 1
