# Ashcrown Mace — Ornate → Exquisite (8 objectives)
# 1. Kill 5,000 mobs
...
# 3. Block 25,000 damage
execute if score @s ec.sp_damage_blocked matches 25000.. run scoreboard players add @s ec.sp_obj_done 1
