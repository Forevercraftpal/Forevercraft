# Zephyr Edge — Mythical → Spirit (10 objectives)
# 1. Kill 50,000 mobs
execute if score @s ec.sp_kills matches 50000.. run scoreboard players add @s ec.sp_obj_done 1
# 2. Dodge 15,000 attacks
execute if score @s ec.sp_dodges matches 15000.. run scoreboard players add @s ec.sp_obj_done 1
