...
tellraw @s ["",{text:"[Forevercraft] ",color:"gold"},{text:"You received an ",color:"gray"},{text:"Uncommon Achievement Crate",color:"blue"},{text:" + ",color:"gray"},{text:"25 XP",color:"green"},{text:"!",color:"gray"}]
