...
tellraw @s ["",{text:"[Forevercraft] ",color:"gold"},{text:"You received a ",color:"gray"},{text:"Rare Achievement Crate",color:"aqua"},{text:" + ",color:"gray"},{text:"50 XP",color:"green"},{text:"!",color:"gray"}]
