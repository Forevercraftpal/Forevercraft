# T10 Collapse Phase 2 — Fill next 12 columns
...
$execute positioned $(ax) 300 $(az) run fill ~12 ~ ~ ~23 ~22 ~47 bedrock
playsound minecraft:entity.generic.explode master @s ~ ~ ~ 1 0.5
tellraw @s {"text":"The walls close in...","color":"dark_red","italic":true}
