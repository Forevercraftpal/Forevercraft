# Artisan Tome — Quest 100 Complete! Grand Finale!
# The ultimate celebration for completing all 100 artisan tome quests

# Title sequence
title @s times 20 100 40
title @s subtitle {"text":"All 100 Quests Complete","color":"gold","italic":true}
title @s title [{"text":"ARTISAN TOME","color":"green","bold":true},{"text":" \u2014 ","color":"dark_gray"},{"text":"MASTERED","color":"gold","bold":true}]
...
# Server announcement
tellraw @a [{"text":""},{"text":"[Forevercraft] ","color":"gold"},{"selector":"@s","color":"green","bold":true},{"text":" has completed all ","color":"gray"},{"text":"100 Artisan Tome quests","color":"green","bold":true},{"text":"!","color":"gray"}]

# Bonus: grant 100 additional experience levels
experience add @s 100 levels
tellraw @s [{text:"  "},{"text":"+100 bonus levels ","color":"green","bold":true},{"text":"for mastering the Artisan Tome!","color":"green"}]
