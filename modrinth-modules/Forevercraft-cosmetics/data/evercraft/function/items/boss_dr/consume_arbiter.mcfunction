# Consume Condensed Gale — Permanently increases dream rate by +1
# Triggered by advancement: evercraft:items/boss_dr/consume_arbiter

advancement revoke @s only evercraft:items/boss_dr/consume_arbiter
...
attribute @s luck modifier add evercraft:boss_dr_4 1 add_value
...
tellraw @s [{text:"✦ ",color:"light_purple"},{text:"CONDENSED GALE CONSUMED",color:"dark_purple",bold:true},{text:" ✦",color:"light_purple"}]
